...
ols_formula <- formula(paste("inter_state ~ wheat_aid + risocode + year:wb_region",  paste(US_controls, collapse = "+") , paste(country_chars_controls, collapse = "+") , paste(cereals_controls, collapse = "+"), paste(weather_controls, collapse = "+"),sep="+")
)
